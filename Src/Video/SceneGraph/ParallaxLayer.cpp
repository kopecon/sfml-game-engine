#include "Video/SceneGraph/ParallaxLayer.hpp"
#include "math.hpp"
...
namespace render {
    ...
    void ParallaxLayer::update() noexcept {
        ...
        const sf::Vector2i rectSize{utils::math::hd::divide(viewSize, scale)};

        const sf::Vector2i rectPos{utils::math::hd::divide(delta * scrollSpeed_, scale) - static_cast<sf::Vector2f>(rectSize) / 2.f};
